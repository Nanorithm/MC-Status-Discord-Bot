...
client.login('ODg0NDg2ODQ1MzYxMTg4OTI0.YTZMkA.VcC7VUiQbaqu91VcUVRjb0zfqkQ');
...
const SERVER_ADDRESS = 'yeetcraft.minecraft.best'; // Put your minecraft server IP or hostname here (e.g. '192.168.0.1')
...
const IP_RESPONSE = 'The address for the server is `{address}`'; // {address} and {port} will show server ip and port from above
